...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="India" domain="groomturban.com" />
      <GallerySection />
      <DynamicServicesSection location="India" domain="groomturban.com" />
      <DynamicFooter location="India" domain="groomturban.com" />
      <WhatsAppFloat />
    </main>
  )
}
